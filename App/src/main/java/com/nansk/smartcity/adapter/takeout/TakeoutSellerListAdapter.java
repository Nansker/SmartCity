...
public class TakeoutSellerListAdapter extends RecyclerView.Adapter<TakeoutSellerListAdapter.BodyViewHolder> {
    private Context context;
    private List<TakeoutSellerBean.RowsBean> data;

    public TakeoutSellerListAdapter(Context context, List<TakeoutSellerBean.RowsBean> data) {
